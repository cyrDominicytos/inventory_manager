...
-- Listage des données de la table inventory_manager.bills : ~2 rows (environ)
...
REPLACE INTO `bills` (`bill_id`, `bill_mecef_date_time`, `bill_code`, `bill_type`, `bill_mecef_qr_code`, `bill_mecef_code_dgi`, `bill_mecef_counters`, `bill_mecef_nim`, `bill_certify_bill`, `bill_taa`, `bill_tab`, `bill_tac`, `bill_tad`, `bill_tae`, `bill_taf`, `bill_hab`, `bill_had`, `bill_vab`, `bill_vad`, `bill_aib`, `bill_ts`, `bill_total`, `bill_uid`, `bill_generate_by`, `bill_sales_id`, `bill_certify_by`, `bill_created_at`, `bill_updated_at`) VALUES
	...
	(8, NULL, 'FV7518', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 7, NULL, '2022-03-07 06:56:08', '2022-03-07 06:56:08');
...
-- Listage des données de la table inventory_manager.delivery_mens : ~3 rows (environ)
...
-- Listage de la structure de la table inventory_manager. equivalence_quantities
...
CREATE TABLE IF NOT EXISTS `equivalence_quantities` (
  ...
  `equivalence_quantities_relation` json DEFAULT NULL,
...
-- Listage des données de la table inventory_manager.equivalence_quantities : ~0 rows (environ)
...
-- Listage des données de la table inventory_manager.orders : ~1 rows (environ)
/*!40000 ALTER TABLE `orders` DISABLE KEYS */;
REPLACE INTO `orders` (`orders_id`, `orders_status`, `orders_amount`, `orders_reduction`, `orders_is_delivable`, `orders_deliver_man`, `orders_aib`, `orders_users_id`, `orders_description`, `orders_client_id`, `orders_delivery_date`, `orders_created_at`, `orders_updated_at`) VALUES
	(1, 2, 4501900000, 0, 0, 0, '0', 0, NULL, 3, '2022-03-26', '2022-03-04 15:34:15', '2022-03-07 06:16:33');
...
-- Listage des données de la table inventory_manager.orders_details : ~2 rows (environ)
/*!40000 ALTER TABLE `orders_details` DISABLE KEYS */;
REPLACE INTO `orders_details` (`orders_details_id`, `orders_details_amount`, `orders_details_reduction`, `orders_details_quantity`, `orders_details_orders_id`, `orders_details_sales_options_id`, `orders_details_products_id`, `orders_default_price`, `orders_selling_price`, `orders_details_created_at`, `orders_details_updated_at`) VALUES
	(9, 1900000, 0, 5, 1, 2, 2, 380000, 380000, '2022-03-07 06:16:33', '2022-03-07 06:16:33'),
	(10, 4500000000, 0, 10000, 1, 2, 1, 450000, 450000, '2022-03-07 06:16:33', '2022-03-07 06:16:33');
...
-- Listage des données de la table inventory_manager.product_prices : ~9 rows (environ)
...
REPLACE INTO `product_prices` (`product_prices_id`, `product_prices_price`, `product_prices_product_id`, `product_prices_sales_option_id`, `product_prices_created_at`, `product_prices_updated_at`) VALUES
	(1, 350000, 1, 2, '2022-03-02 15:43:52', '2022-03-07 16:03:50'),
...
REPLACE INTO `sales` (`sales_id`, `sales_status`, `sales_amount`, `sales_reduction`, `sales_is_commanded`, `sales_is_delivable`, `sales_deliver_man`, `sales_aib`, `sales_delivery_date`, `sales_client_id`, `sales_users_id`, `sales_created_at`, `sales_updated_at`) VALUES
	...
	(7, 3, 1660000, 1660000, 0, 0, 1, '0', '0000-00-00', 4, 1, '2022-03-07 06:37:29', '2022-03-07 06:56:08'),
	(9, 2, 4000, 4000, 0, 0, 1, '0', '0000-00-00', 3, 1, '2022-03-07 06:43:29', '2022-03-07 06:43:29'),
	(10, 2, 1660000, 1660000, 0, 0, 1, '0', '0000-00-00', 4, 1, '2022-03-07 06:46:51', '2022-03-07 06:46:51'),
	(13, 2, 2700, 2700, 1, 0, 1, '0', '0000-00-00', 2, 1, '2022-03-07 07:00:16', '2022-03-07 07:00:16');
...
-- Listage des données de la table inventory_manager.sales_options : ~8 rows (environ)
...
-- Listage des données de la table inventory_manager.sell_details : ~25 rows (environ)
...
REPLACE INTO `sell_details` (`sell_details_id`, `sell_details_amount`, `sell_details_quantity`, `sell_details_reduction`, `sell_details_sales_options_id`, `sell_details_sales_id`, `sell_details_products_id`, `sell_details_default_price`, `sell_details_selling_price`, `sell_details_created_at`, `sell_details_updated_at`) VALUES
	...
	(29, 760000, 2, 0, 2, 7, 2, 380000, 380000, '2022-03-07 06:37:30', '2022-03-07 06:37:30'),
	(30, 900000, 2, 0, 2, 7, 1, 450000, 450000, '2022-03-07 06:37:30', '2022-03-07 06:37:30'),
	(32, 4000, 5, 0, 1, 9, 5, 800, 800, '2022-03-07 06:43:29', '2022-03-07 06:43:29'),
	(33, 760000, 2, 0, 2, 10, 2, 380000, 380000, '2022-03-07 06:46:51', '2022-03-07 06:46:51'),
	(34, 900000, 2, 0, 2, 10, 1, 450000, 450000, '2022-03-07 06:46:51', '2022-03-07 06:46:51'),
	(39, 2700, 2, 0, 5, 13, 6, 1350, 1350, '2022-03-07 07:00:16', '2022-03-07 07:00:16');
...
REPLACE INTO `users` (`id`, `ip_address`, `username`, `password`, `email`, `activation_selector`, `activation_code`, `forgotten_password_selector`, `forgotten_password_code`, `forgotten_password_time`, `remember_selector`, `remember_code`, `created_at`, `updated_at`, `last_login`, `active`, `first_name`, `last_name`, `company`, `phone`, `address`) VALUES
	(1, '127.0.0.1', 'administrator', '$2y$12$Upka3da/v2XVpzxqs3aV0u6dQ6ZGCzW0uNd2YIwj1ir3o6uDIwXw.', 'admin@admin.com', NULL, '', NULL, NULL, NULL, NULL, NULL, '2022-03-02 14:52:22', '2022-03-07 16:01:42', 1646665302, 1, 'Admin', 'istrator', 'ADMIN', '65656565', 'Cotonou'),
...
-- Listage de la structure de déclencheur inventory_manager. orders_details_before_insert
...
DROP TRIGGER IF EXISTS `product_prices_after_insert`;
