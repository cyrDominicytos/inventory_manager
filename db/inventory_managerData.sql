...
INSERT INTO `config` (`config_id`, `config_code`, `config_name`, `config_description`, `config_value`, `config_created_at`, `config_updated_at`) VALUES
	(1, 1, 'company_name', 'Nom de l\'entreprise', 'MYAH IT COMPANY', '2022-02-22 10:47:47', '2022-02-22 10:47:47'),
	(2, 2, 'company_ifu', 'Numéro IFU de l\'entreprise', '', '2022-02-22 10:47:47', '2022-02-22 10:47:47'),
	(3, 3, 'company_email', 'Email de l\'entreprise', '', '2022-02-22 10:47:47', '2022-02-22 10:47:47'),
	(4, 4, 'company_phone_number', 'Numéro de téléphone de l\'entreprise', '', '2022-02-22 10:47:47', '2022-02-22 10:47:47'),
	(5, 5, 'company_address', 'Adresse physique de l\'entreprise', '', '2022-02-22 10:47:47', '2022-02-22 10:47:47'),
	(6, 6, 'company_product_identity', 'Identificateur des produits de l\'entreprise', 'barre_code', '2022-02-22 10:47:47', '2022-02-22 10:47:47'),
	(7, 7, 'company_identity', 'Identifiant de connexion de l\'entreprise', 'email', '2022-02-22 10:47:47', '2022-02-22 10:47:47'),
	(8, 8, 'company_created_at', 'Date de création de l\'entreprise', '', '2022-02-22 10:47:47', '2022-02-22 10:47:47'),
	(9, 9, 'company_site_url', 'Adresse de site web de l\'entreprise', '', '2022-02-22 10:47:47', '2022-02-22 10:47:47');
...
INSERT INTO `exonerations` (`exonerations_id`, `exonerations_name`, `exonerations_slug`, `exonerations_rate`, `exonerations_created_at`, `exonerations_updated_at`) VALUES
	(1, 'A', '[A : Exonération totale]', '0', '2022-02-22 10:47:48', '2022-02-22 10:47:48'),
	(2, 'B', '[B : 18%]', '18', '2022-02-22 10:47:48', '2022-02-22 10:47:48'),
	(3, 'E', '[E : Exonération totale]', '0', '2022-02-22 10:47:48', '2022-02-22 10:47:48');
...
INSERT INTO `migrations` (`id`, `version`, `class`, `group`, `namespace`, `time`, `batch`) VALUES
	(1, '20181211100537', 'IonAuth\\Database\\Migrations\\Migration_Install_ion_auth', '', 'IonAuth', 1645523261, 1);
...
-- Listage des données de la table inventory_manager.product_categories : ~0 rows (environ)
...
-- Listage des données de la table inventory_manager.sales_options : ~0 rows (environ)
...
-- Listage des données de la table inventory_manager.supplies : ~0 rows (environ)
...
INSERT INTO `users` (`id`, `ip_address`, `username`, `password`, `email`, `activation_selector`, `activation_code`, `forgotten_password_selector`, `forgotten_password_code`, `forgotten_password_time`, `remember_selector`, `remember_code`, `created_at`, `updated_at`, `last_login`, `active`, `first_name`, `last_name`, `company`, `phone`, `address`) VALUES
	(1, '127.0.0.1', 'administrator', '$2y$08$200Z6ZZbp3RAEXoaWcMA6uJOFicwNZaqk4oDhqTUiFXFe63MG.Daa', 'admin@admin.com', NULL, '', NULL, NULL, NULL, NULL, NULL, '2022-02-22 10:47:47', '2022-02-22 10:47:47', 1268889823, 1, 'Admin', 'istrator', 'ADMIN', '65656565', 'Cotonou'),
	(2, '127.0.0.1', 'Vendeur', '$2y$08$200Z6ZZbp3RAEXoaWcMA6uJOFicwNZaqk4oDhqTUiFXFe63MG.Daa', 'vendeur@vendeur.com', NULL, '', NULL, NULL, NULL, NULL, NULL, '2022-02-22 10:47:47', '2022-02-22 10:47:47', 1268889823, 1, 'Pierre', 'ALI', 'Seller', '66666666', 'Cotonou');
