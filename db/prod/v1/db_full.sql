...
-- Listage des données de la table gbarstock.clients : ~0 rows (environ)
...
-- Listage de la structure de la vue gbarstock. inventory
DROP VIEW IF EXISTS `inventory`;
-- Création d'une table temporaire pour palier aux erreurs de dépendances de VIEW
CREATE TABLE `inventory` (
	`supplies_id` MEDIUMINT(8) UNSIGNED NOT NULL,
	`supplies_code_barre` TEXT NULL COLLATE 'utf8_general_ci',
	...
	`sell_details_id` MEDIUMINT(8) UNSIGNED NULL,
	`sell_details_amount` DOUBLE NULL,
	`sell_details_quantity` MEDIUMINT(8) UNSIGNED NULL,
	`sell_details_reduction` MEDIUMINT(8) UNSIGNED NULL,
	`sell_details_sales_options_id` MEDIUMINT(8) UNSIGNED NULL,
	`sell_details_sales_id` MEDIUMINT(8) UNSIGNED NULL,
	`sell_details_products_id` MEDIUMINT(8) UNSIGNED NULL,
	`sell_details_default_price` DOUBLE NULL,
	`sell_details_selling_price` DOUBLE NULL,
	`sell_details_created_at` DATETIME NULL,
	`sell_details_updated_at` DATETIME NULL,
	`products_id` MEDIUMINT(8) UNSIGNED NULL,
	`products_name` VARCHAR(100) NULL COLLATE 'utf8_general_ci',
	`products_barre_code` VARCHAR(255) NULL COLLATE 'utf8_general_ci',
	`products_description` TEXT NULL COLLATE 'utf8_general_ci',
	`products_isActive` TINYINT(1) UNSIGNED NULL,
	`products_product_categorie_id` MEDIUMINT(8) UNSIGNED NULL,
	`products_exonerations_id` MEDIUMINT(8) UNSIGNED NULL,
	`products_created_at` DATETIME NULL,
	`products_updated_at` DATETIME NULL,
	`sales_options_id` MEDIUMINT(8) UNSIGNED NULL,
	`sales_options_name` VARCHAR(100) NULL COLLATE 'utf8_general_ci',
	`sales_options_description` TEXT NULL COLLATE 'utf8_general_ci',
	`sales_options_isActive` TINYINT(1) UNSIGNED NULL,
	`sales_options_created_at` DATETIME NULL,
	`sales_options_updated_at` DATETIME NULL,
	`product_categories_id` MEDIUMINT(8) UNSIGNED NULL,
	...
	`sell_quantity_total` DECIMAL(30,0) NOT NULL,
...
-- Listage des données de la table gbarstock.migrations : ~0 rows (environ)
...
-- Listage des données de la table gbarstock.providers : ~2 rows (environ)
...
-- Listage des données de la table gbarstock.sales_options : ~9 rows (environ)
...
-- Listage des données de la table gbarstock.supplies : ~2 rows (environ)
...
IFNULL(sum(`sell_details`.`sell_details_quantity`),0)  AS `sell_quantity_total`,
 
(sum(`supplies`.`supplies_selling_quantity`) - IFNULL(sum(`sell_details`.`sell_details_quantity`),0)) AS `quantity_inventory` 
