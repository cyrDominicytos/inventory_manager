...
CREATE TABLE IF NOT EXISTS `bills` (
  ...
  `bill_taa` varchar(50) DEFAULT NULL,
  `bill_tac` varchar(50) DEFAULT NULL,
  `bill_tad` varchar(50) DEFAULT NULL,
  `bill_tab` varchar(50) DEFAULT NULL,
  `bill_tae` varchar(50) DEFAULT NULL,
  `bill_taf` varchar(50) DEFAULT NULL,
  `bill_hab` varchar(50) DEFAULT NULL,
  `bill_had` varchar(50) DEFAULT NULL,
  `bill_vad` varchar(50) DEFAULT NULL,
  `bill_vab` varchar(50) DEFAULT NULL,
  `bill_aib` varchar(50) DEFAULT NULL,
  `bill_ts` varchar(50) DEFAULT NULL,
  `bill_total` varchar(50) DEFAULT NULL,
...
-- Listage des données de la table inventory_manager.bills : ~5 rows (environ)
/*!40000 ALTER TABLE `bills` DISABLE KEYS */;
INSERT INTO `bills` (`bill_id`, `bill_mecef_date_time`, `bill_code`, `bill_mecef_qr_code`, `bill_type`, `bill_mecef_code_dgi`, `bill_mecef_counters`, `bill_mecef_nim`, `bill_certify_bill`, `bill_taa`, `bill_tac`, `bill_tad`, `bill_tab`, `bill_tae`, `bill_taf`, `bill_hab`, `bill_had`, `bill_vad`, `bill_vab`, `bill_aib`, `bill_ts`, `bill_total`, `bill_generate_by`, `bill_sales_id`, `bill_certify_by`, `bill_created_at`, `bill_updated_at`) VALUES
	(11, '0000-00-00 00:00:00', 'FLN8513', 'F;TS01000259;TESTIUQOPKRHTWFUFFVRRZHY;0202112473644;20220301103530', NULL, 'TEST-IUQO-PKRH-TWFU-FFVR-RZHY', '201/223 FV', 'TS01000259', '1', '2258000', '0', '0', NULL, '0', '0', '0', '0', '0', NULL, '0', '0', NULL, 1, 9, 1, '2022-03-01 10:10:29', '2022-03-01 10:35:30'),
	(20, '0000-00-00 00:00:00', 'FLN1940', 'F;TS01000259;TESTNTMDGTC3D3IMEWKLD2I7;0202112473644;20220301131017', NULL, 'TEST-NTMD-GTC3-D3IM-EWKL-D2I7', '203/225 FV', 'TS01000259', '1', '2258000', '0', '0', NULL, '0', '0', '0', '0', '0', NULL, '0', '0', NULL, 1, 10, 1, '2022-03-01 13:08:57', '2022-03-01 13:10:16'),
	(21, '0000-00-00 00:00:00', 'FLN6208', 'F;TS01000259;TESTUHQ7LMAQD4YHE74EGSDL;0202112473644;20220301182336', 'FV', 'TEST-UHQ7-LMAQ-D4YH-E74E-GSDL', '207/229 FV', 'TS01000259', '1', '8000', '0', '2250000', NULL, '0', '0', '0', '1906780', '343220', NULL, '0', '0', NULL, 1, 11, 1, '2022-03-01 13:10:35', '2022-03-01 18:23:36'),
	(22, '0000-00-00 00:00:00', 'FLN4023', 'F;TS01000259;TESTEO2WCHDBMAXVIO3CYOBD;0202112473644;20220301171516', NULL, 'TEST-EO2W-CHDB-MAXV-IO3C-YOBD', '204/226 FV', 'TS01000259', '1', '0', '0', '900000', NULL, '0', '0', '1483051', '762712', '137288', NULL, '0', '0', NULL, 1, 12, 1, '2022-03-01 17:15:08', '2022-03-01 17:15:16'),
	(23, '0000-00-00 00:00:00', 'FLN5731', 'F;TS01000259;TESTMCXEQLDZQZVGI2XRG46G;0202112473644;20220301174856', 'FV', 'TEST-MCXE-QLDZ-QZVG-I2XR-G46G', '205/227 FV', 'TS01000259', '1', '0', '0', '2250000', NULL, '0', '0', '593220', '1906780', '343220', NULL, '29661', '0', NULL, 1, 13, 1, '2022-03-01 17:44:34', '2022-03-01 17:48:56');
...
INSERT INTO `config` (`config_id`, `config_code`, `config_name`, `config_description`, `config_value`, `config_created_at`, `config_updated_at`) VALUES
	...
	(2, 2, 'company_ifu', 'Numéro IFU de l\'entreprise', '0202112473644', '2022-02-23 13:51:47', '2022-03-01 09:50:49'),
	(3, 3, 'company_email', 'Email de l\'entreprise', 'contact@myahitcompany.com', '2022-02-23 13:51:47', '2022-03-01 15:53:01'),
	(4, 4, 'company_phone_number', 'Numéro de téléphone de l\'entreprise', '+229 69 93 67 67', '2022-02-23 13:51:47', '2022-03-01 15:53:20'),
	(5, 5, 'company_address', 'Adresse physique de l\'entreprise', 'Bénin, Cotonou, Agla', '2022-02-23 13:51:47', '2022-03-01 15:49:55'),
	...
	(8, 8, 'company_created_at', 'Date de création de l\'entreprise', '03/01/2019', '2022-02-23 13:51:47', '2022-03-01 15:44:00'),
	(9, 9, 'company_site_url', 'Adresse de site web de l\'entreprise', 'https://www.myahitcompany.com', '2022-02-23 13:51:47', '2022-03-01 15:45:52'),
	(10, 10, 'company_rccm', 'Registre de commerce de l\'entreprise', 'RCCM RB/ABC/21 B', '2022-03-01 15:52:20', '2022-03-01 15:52:20');
...
INSERT INTO `exonerations` (`exonerations_id`, `exonerations_name`, `exonerations_slug`, `exonerations_rate`, `exonerations_created_at`, `exonerations_updated_at`) VALUES
	...
	(4, 'C', '[C : Exonération totale]', '0', '2022-03-01 17:11:13', '2022-03-01 17:11:37'),
	(5, 'D', '[D :18%]', '18', '2022-03-01 17:12:11', '2022-03-01 17:12:11'),
	(6, 'F', '[F : Exonération totale]', '0', '2022-03-01 17:12:29', '2022-03-01 17:12:41');
...
INSERT INTO `products` (`products_id`, `products_name`, `products_barre_code`, `products_description`, `products_isActive`, `products_product_categorie_id`, `products_exonerations_id`, `products_created_at`, `products_updated_at`) VALUES
	(1, 'ORDINATEUR HP ELITE BOOK', NULL, '', 1, 1, 2, '2022-02-22 11:09:47', '2022-03-01 17:14:00'),
	(2, 'Ordinateur TOSHIBA', NULL, '', 1, 1, 5, '2022-02-22 11:10:15', '2022-03-01 17:14:11'),
...
-- Listage des données de la table inventory_manager.sales : ~7 rows (environ)
/*!40000 ALTER TABLE `sales` DISABLE KEYS */;
INSERT INTO `sales` (`sales_id`, `sales_status`, `sales_amount`, `sales_reduction`, `sales_is_commanded`, `sales_is_delivable`, `sales_deliver_man`, `sales_aib`, `sales_delivery_date`, `sales_client_id`, `sales_users_id`, `sales_created_at`, `sales_updated_at`) VALUES
	(1, 1, 0, 0, 0, 0, 0, '0', '0000-00-00', 1, 0, '2022-02-23 13:51:47', '2022-02-23 13:51:47'),
	(9, 4, 2300000, 2300000, 0, 0, 2, '0', '0000-00-00', 3, 0, '2022-03-01 09:58:14', '2022-03-01 13:08:10'),
	(10, 4, 2258000, 2258000, 0, 0, 2, '0', '0000-00-00', 3, 0, '2022-03-01 10:34:44', '2022-03-01 13:10:16'),
	(11, 4, 2258000, 2258000, 0, 0, 2, '0', '0000-00-00', 3, 0, '2022-03-01 10:35:18', '2022-03-01 18:23:36'),
	(12, 4, 2650000, 2650000, 0, 0, 2, '0', '2022-03-02', 3, 1, '2022-03-01 17:15:08', '2022-03-01 17:15:16'),
	(13, 4, 2950000, 2950000, 0, 0, 2, 'B', '0000-00-00', 3, 1, '2022-03-01 17:43:03', '2022-03-01 17:48:56');
...
-- Listage des données de la table inventory_manager.sell_details : ~14 rows (environ)
/*!40000 ALTER TABLE `sell_details` DISABLE KEYS */;
INSERT INTO `sell_details` (`sell_details_id`, `sell_details_amount`, `sell_details_quantity`, `sell_details_reduction`, `sell_details_sales_options_id`, `sell_details_sales_id`, `sell_details_products_id`, `sell_details_default_price`, `sell_details_selling_price`, `sell_details_created_at`, `sell_details_updated_at`) VALUES
	(1, 0, 5, 0, 2, 1, 1, 0, 0, '2022-02-28 13:22:32', '2022-03-01 09:57:25'),
	(2, 0, 0, 0, 2, 1, 3, 0, 0, '2022-02-28 13:46:26', '2022-02-28 13:46:26'),
	(3, 0, 0, 0, 5, 1, 5, 0, 0, '2022-02-28 13:48:06', '2022-02-28 13:48:06'),
	(4, 0, 0, 0, 1, 1, 5, 0, 0, '2022-02-28 13:48:25', '2022-02-28 13:48:25'),
	(15, 1400000, 4, 0, 2, 9, 1, 0, 0, '2022-03-01 09:58:14', '2022-03-01 09:58:14'),
	(16, 900000, 2, 0, 2, 9, 2, 450000, 450000, '2022-03-01 09:58:14', '2022-03-01 10:03:48'),
	(17, 8000, 10, 0, 1, 10, 5, 800, 800, '2022-03-01 10:34:44', '2022-03-01 10:34:44'),
	(18, 2250000, 5, 0, 2, 10, 2, 450000, 450000, '2022-03-01 10:34:44', '2022-03-01 10:34:44'),
	(19, 8000, 10, 0, 1, 11, 5, 800, 800, '2022-03-01 10:35:19', '2022-03-01 10:35:19'),
	(20, 2250000, 5, 0, 2, 11, 2, 450000, 450000, '2022-03-01 10:35:19', '2022-03-01 10:35:19'),
	(21, 1750000, 5, 0, 2, 12, 1, 350000, 350000, '2022-03-01 17:15:08', '2022-03-01 17:15:08'),
	(22, 900000, 2, 0, 2, 12, 2, 450000, 450000, '2022-03-01 17:15:08', '2022-03-01 17:15:08'),
	(23, 2250000, 5, 0, 2, 13, 2, 450000, 450000, '2022-03-01 17:43:03', '2022-03-01 17:43:03'),
	(24, 700000, 2, 0, 2, 13, 1, 350000, 350000, '2022-03-01 17:43:04', '2022-03-01 17:43:04');
...
-- Listage des données de la table inventory_manager.supplies : ~5 rows (environ)
...
INSERT INTO `supplies` (`supplies_id`, `supplies_code_barre`, `supplies_cost`, `supplies_selling_price`, `supplies_selling_quantity`, `supplies_provider_id`, `supplies_sales_options_id`, `supplies_products_id`, `supplies_created_at`, `supplies_updated_at`) VALUES
	...
	(4, NULL, 0, 1300, 0, 1, 5, 5, '2022-03-01 09:37:23', '2022-03-01 09:37:23'),
	(5, NULL, 0, 800, 5, 1, 1, 5, '2022-03-01 09:37:23', '2022-03-02 14:44:56');
...
INSERT INTO `users` (`id`, `ip_address`, `username`, `password`, `email`, `activation_selector`, `activation_code`, `forgotten_password_selector`, `forgotten_password_code`, `forgotten_password_time`, `remember_selector`, `remember_code`, `created_at`, `updated_at`, `last_login`, `active`, `first_name`, `last_name`, `company`, `phone`, `address`) VALUES
	(1, '127.0.0.1', 'administrator', '$2y$12$caoses2LIMJL19KUJstjSepsseVL9/JzlXa9LhTJIpXwXkNzBxyMK', 'admin@admin.com', NULL, '', NULL, NULL, NULL, NULL, NULL, '2022-02-23 13:51:46', '2022-03-02 12:41:55', 1646221315, 1, 'Admin', 'istrator', 'ADMIN', '65656565', 'Cotonou'),
