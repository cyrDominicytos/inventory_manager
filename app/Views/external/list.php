                    ...
                    <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_table_users">
                        ...
                        <thead>
                            ...
                            <tr class="text-start text-muted fw-bolder fs-7 text-uppercase gs-0">
                                ...
                                <th class="min-w-125px" style="color:black;font-size:medium">Nom Complet</th>
                                <th class="min-w-125px" style="color:black;font-size:medium">Téléphone</th>
                                <th class="min-w-125px" style="color:black;font-size:medium">IFU</th>
                                <th class="min-w-125px" style="color:black;font-size:medium">Email</th>
                                <th class="min-w-125px" style="color:black;font-size:medium">Adresse</th>
                            ...
                            <?php $i = 1; foreach ($external as $user): ?>
                                <!--begin::Table row-->
                                    <tr>
                                        ...
                                        <td style="color:black"><?= $user[$tables.'_phone_number']  ?></td>
                                        <td class="" style="color:black"><?= $user[$tables.'_ifu']  ?></td>
                                        <td style="color:black"><?= $user[$tables.'_email']  ?></td>
                                        ...
                                        <td style="color:black"><?= format_date( $user[$tables.'_created_at'] , "d/m/Y à H:i:s")  ?></td>
                                        <td class="text-end">
