                    ...
                    <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_table_users">
                        ...
                        <thead>
                            ...
                            <tr class="text-start text-muted fw-bolder fs-7 text-uppercase gs-0">
                                ...
                                <th class="min-w-125px" style="color:black;font-size:medium">Catégories</th>
                                <th class="min-w-125px" style="color:black;font-size:medium">Produits</th>
                                <th class="min-w-125px" style="color:black;font-size:medium">Option de Vente</th>
                                <th class="min-w-125px" style="color:black;font-size:medium">Prix de vente</th>
                            ...
                            <?php $i = 1; foreach ($product_prices as $product): ?>
                                <!--begin::Table row-->
                                    <tr>
                                        ...
                                        <td class="" style="color: black;">
                                        <?= $product->product_prices_price?> FCFA
                                        </td>
                                        <td style="color: black;"><?= format_date($product->products_created_at , "d/m/Y à H:i:s") ?></td>
                                        <td class="text-end">
