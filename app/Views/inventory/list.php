                ...
                <div class="card-header border-0 pt-6">
                    ...
                    <div class="card-toolbar">
                        ...
                        <div class="d-flex justify-content-end" data-kt-user-table-toolbar="base">
                            ...
                            <!--end::Filter-->
                            <!--begin::Export-->
                            <a class="btn btn-light-primary me-3" href="<?= base_url() ?>/inventory_pdf" target="_blank">
                    ...
                    <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_table_users">
                        ...
                        <thead>
                            ...
                            <tr class="text-start text-muted fw-bolder fs-7 text-uppercase gs-0">
                                ...
                                <th class="min-w-125px" style="color:black;font-size:medium">Quantités Approvisionnées</th>
                                <th class="min-w-125px" style="color:black;font-size:medium">Quantités Vendues</th>
                                <th class="min-w-125px" style="color:black;font-size:medium">Quantités Restantes</th>
                                <th class="min-w-5px" style="color:black;font-size:medium"></th>
                            </tr>
                            <!--end::Table row-->
                        </thead>
                        <!--end::Table head-->
