                ...
                <div class="card-header border-0 pt-6">
                    ...
                    <div class="card-title">
                        ...
                        <div class="d-flex align-items-center position-relative my-1">
                            ...
                            <!--end::Svg Icon-->
                            <input type="text" data-kt-user-table-filter="search" class="form-control form-control-solid w-250px ps-14" placeholder="Rechercher utilisateur" />
                        </div>
                        <!--end::Search-->
                    </div>
                    <!--begin::Card title-->
                    ...
                    <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_table_users">
                        ...
                        <thead>
                            ...
                            <tr class="text-start text-muted fw-bolder fs-7 text-uppercase gs-0">
                                ...
                                <th class="min-w-125px"  style="color:black;font-size:medium">Noms et Prénoms</th>
                                <th class="min-w-125px"  style="color:black;font-size:medium">Profile</th>
                                <th class="min-w-125px"  style="color:black;font-size:medium">Email</th>
                                <th class="min-w-125px"  style="color:black;font-size:medium">Téléphone</th>
                            ...
                            <?php foreach ($users as $user): ?>
                                <!--begin::Table row-->
                                    <tr>
                                        ...
                                        <td style="color:black" class="text-capitalize"><?= $auth->getUsersGroups($user->id)->getResult()[0]->name ?></td>
                                        <td style="color:black"><?= $user->email?></td>
                                        <td style="color:black"><?= $user->phone?></td>
                                        <td> 
                                            <?= status($user->active) ?>
                                       </td>
                                        <td style="color:black"><?= format_date($user->created_at, "d/m/Y à H:i:s")?></td>
                                        <td class="text-end">
