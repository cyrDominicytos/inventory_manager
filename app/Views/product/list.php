                    ...
                    <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_table_users">
                        ...
                        <thead>
                            ...
                            <tr class="text-start text-muted fw-bolder fs-7 text-uppercase gs-0">
                                ...
                                <th class="min-w-125px" style="color:black;font-size:medium">Désignation</th>
                                <th class="min-w-125px" style="color:black;font-size:medium">Catégorie</th>
                                <th class="min-w-125px" style="color:black;font-size:medium">Exonération</th>
                                <th class="min-w-125px" style="color:black;font-size:medium">Description</th>
