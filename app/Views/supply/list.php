                    ...
                    <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_table_users">
                        ...
                        <thead>
                            ...
                            <tr class="text-start text-muted fw-bolder fs-7 text-uppercase gs-0">
                                ...
                                <th class="min-w-125px"  style="color:black;font-size:medium">Fournisseurs</th>
                                <th class="min-w-125px"  style="color:black;font-size:medium">Produits</th>
                                <th class="min-w-125px"  style="color:black;font-size:medium">Options de vente</th>
                                <th class="min-w-125px"  style="color:black;font-size:medium">PU</th>
                                <th class="min-w-125px"  style="color:black;font-size:medium">Cout Achat</th>
                                <th class="min-w-125px"  style="color:black;font-size:medium">Quantités</th>
                            ...
                            <?php $i = 1; foreach ($supplies as $supply): ?>
                                <!--begin::Table row-->
                                    <tr>
                                        ...
                                        <td style="color:black"><?= format_date($supply->supplies_created_at, "d/m/Y à H:i:s") ?></td>
                                        <td class="text-end">
                                            
                                                
                                                <!--begin::Menu item-->
                                                 <!-- Edition et suppression disponibles si et seule;ent si la quantité approvisionnée est supéreure ou égale à ce qui reste en stock -->
                                                <?php if(array_key_exists($supply->supplies_products_id.$supply->supplies_sales_options_id, $inventory_data) && $inventory_data[$supply->supplies_products_id.$supply->supplies_sales_options_id] >= $supply->supplies_selling_quantity) :?>
                                                ...
                                                <?php else: ?>
                                                    <div class='badge badge-success fw-bolder'>Produit vendu</div>
                                                <?php endif;?>
                                                <!--end::Menu item-->
